...
def _copy_last_reports_to_docs(reports: List[Dict], max_reports: int = 7) -> List[Dict]:
    """
    Copy last N reports into docs/reports/html and docs/reports/pdf.
    Avoid SameFileError if source==dest.
    Return list referencing DEST files.
    """
...
def _build_extra_reports_sidebar_html(extra_reports: List[Dict]) -> str:
    ...
    for rep in extra_reports:
        ...
        url = rep["url"]
        date_str = rep["date"]
        days_left = int(rep.get("days_left", 0) or 0)
...
"""
    ...
    extra_reports_html = _build_extra_reports_sidebar_html(_load_extra_reports())
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .brand-pill span:first-child { font-weight:600; padding-right:4px; }
    .brand-pill span:last-child { font-weight:600; color:var(--accent-dark); }
    .brand-tagline {
      font-size:11px;
    ...
    body[data-theme="dark"] .theme-toggle { background: #020617; }
    .theme-thumb {
      width: 16px;
      height: 16px;
      border-radius: 999px;
    ...
    .side-report-item + .side-report-item { margin-top: 4px; }
    .side-report-date { font-size: 12px; font-weight: 500; }
    .side-report-links { font-size: 11px; color: var(--text-muted); }
    .side-report-links a {
      color: var(--accent-dark);
      text-decoration: none;
      font-weight: 500;
    }
    body[data-theme="dark"] .side-report-links a { color: #60a5fa; }
    .side-report-links .dot { color: #d1d5db; margin: 0 4px; }

    .extra-report-list { list-style: none; padding-left: 0; margin: 8px 0 0 0; }
    ...
    .extra-report-link:hover { text-decoration: underline; }
...
# -------------------------------------------------------------------
#  BYE PAGE IS A SEPARATE FILE (docs/bye.html)
# -------------------------------------------------------------------

def build_magazine(max_reports: int = 7) -> None:
    """
    - Find reports from reports/ + docs/
    ...
    print(f"[MAG] MaxBits index generated at: {index_path}")
